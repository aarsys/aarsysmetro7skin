...
<%@ Register TagPrefix="dnn" TagName="ACTIONBUTTON4" Src="~/Admin/Containers/ActionButton.ascx" %>
  <div class="PinkTitle">
	    ...
	    <dnn:ICON runat="server" ID="ICON1" cssclass="PinkTitleTIcon" />
    ...
    <div Class="PinkTitleBottom">
        <%-- <dnn:ACTIONBUTTON1 runat="server" id="dnnACTIONBUTTON1" CommandName="AddContent.Action" DisplayIcon="True" DisplayLink="False" /> --%>
    </div>
    <div class="clear"></div>
</div>
