...
<dnn:DnnJsInclude runat="server" FilePath="/DNNMetro_Red/MetroMenu.js" PathNameAlias="SkinPath" />
<dnn:DnnJsInclude runat="server" FilePath="~/Resources/Shared/Scripts/jquery/jquery.hoverIntent.min.js" />
<dnn:DnnCssInclude runat="server" FilePath="/DNNMetro_Red/MetroMenu.css" PathNameAlias="SkinPath" />
