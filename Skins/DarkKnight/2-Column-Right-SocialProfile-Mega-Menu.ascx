...
<div id="DNN6" class="TwoColRightSocialProfile">
    ...
    <div id="Content">
        <div id="Panes">
            ...
            <div class="SocialPanes dnnLeft">
                <div id="LeftPaneSocial" class="LeftPaneSocial dnnLeft" runat="server"></div>
                <div id="SideBarSocial" class="SideBarSocial dnnRight" runat="server"></div>
            </div>
